    ...
    <div className="bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40">
        <div className="py-4">
            <div className="container flex justify-between items-center">
                ...
                text-2xl uppercase sm:text-3xl underline
                "
                >Eshop</a>
                {/* Menu Items */}
                                    ...
                                    <ul className="space-y-2">
                                        {
                                            DropdownLinks.map((data, index) => (
                                              <li key={index}>
                                                ...
                                                hover:text-black dark:hover:text-white duration-200 inline-block w-full p-2 hover:bg-primary/20 rounded-md font-semibold"
                ...
                <div className="flex justify-between items-center gap-4">
                    ...
                    <div className="relative group hidden sm:block">
                        ...
                        />
                        <IoSearch
                        className=" text-gray-600 group-hover:text-primary text-xl dark:text-gray-400 absolute top-1/2 -translate-y-1/2
                    ...
                    <div
                    className="w-4 h-4 bg-red-500 text-white rounded-full absolute top-0 right-0 flex items-center text-xs justify-center"
                    >4</div>
                    </button>
                    <div>
                        <DarkMode/>
