...
const Banner = ({data}) => {
  return (
    <div className='min-h-[550px] flex justify-center items-center py-12'>
        <div 
            style={{backgroundColor: data.bgColor}} className='container'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                ...
                <p data-aos='fade-up' className='text-sm mt-1'>{data.title}</p>
                </div>
                {/* second col */}
                ...
                <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos='fade-up data-aos-offset="0"' >
                        <button data-aos="fade-up" data-aos-offset='0' className='bg-white text-primary py-2 px-4 rounded'>Shop Now</button>
                    </div>
                </div>
            </div>
        </div>
